import { getRecentlyAddedRides } from "@/hooks/storage";
...
// Shows list of rides ordered by how recently they were created
export default function RecentlyAdded() {
  ...
  const getTimeLeft = function (date: Date) {
    ...
    if (timeLeft < 60) {
      ...
      return Math.round(timeLeft / 3600) + " hours";
    } else {
      return Math.round(timeLeft / 86400) + " day(s)";
    }
  };
                ...
                <ListItem.Content>
                  ...
                  <ListItem.Title>
                    <Text style={[styles.label, styles.textDark]}>
                      {ride.rideData.from} <FontAwesome name="long-arrow-right" size={16} color="#333333" /> {ride.rideData.to}
                    </Text>
                  </ListItem.Title>
                  <ListItem.Subtitle>
